...
#########################################
def prepare_moons_data(training_size, test_size, n_features, machine_id=0, num_machines=3, noise=0.1):
    """
    Prepare Moons dataset for binary classification with machine-specific validation sets
    ...
    X, y = make_moons(n_samples=training_size + test_size, noise=noise, random_state=23)
    y = 2 * y - 1  # Convert labels to {-1, +1} for QSVC compatibility
